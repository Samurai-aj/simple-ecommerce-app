...
<html lang="en">
    <head>
        ...
        <title>Kodekloud E-Commerce App</title>
        ...
        <section class="slider_area row m0">
            <div class="slider_inner">
                <div class="camera_caption">
                    <h2 class="wow fadeInUp animated">Make Your Shopping Easy,Fun and colorful</h2>
                    <h5 class="wow fadeIn animated" data-wow-delay="0.3s">Find everything accordingly and swiftly</h5>
